...
export default function CreateContest(){
    ...
    useEffect(()=>{
        const price = contest.slots * contest.entryFee
        if(price){
            setContest({...contest, totalPrize : price - (price * 0.1)})
        }

    },[contest.slots,contest.entryFee])
    ...
    return(
        ...
        <div className="create-contest">
            ...
            <label>Entry Fee</label><br/>
                ...
                <Form.Control disabled type="number" name="totalPrize" placeholder="totalPrize" value={contest.totalPrize} onChange={handleChange}
                required
                /><br/>
